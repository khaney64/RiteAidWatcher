...
{
    // Root myDeserializedClass = JsonConvert.DeserializeObject<StoreRoot>(myJsonResponse); 
    public class SpecialHours
    {
        [JsonProperty("2021-02-12")]
        public string _20210212 { get; set; }
        [JsonProperty("2021-02-13")]
        public string _20210213 { get; set; }
    }
